...
3、使用说明
    ...
    使用方法：
        1、编译后打开调试模式，将PD14连接到PB10，PD15连接到PA5，利用示波器或者逻辑分析仪观察TIM1 TIM8输出波形
        2、当软件输出PD14电平大于PD15时，TIM波形消失，相反时，波形正常输出
4、注意事项
    无
...
3. Instructions for use
    ...
    Instructions:
        1. Open the debug mode after compiling, connect PD14 to PB10, connect PD15 to PA5, and use an oscilloscope or logic analyzer to observe the output waveforms of TIM1 and TIM8
        2. When the software output PD14 level is greater than PD15, the TIM waveform disappears, on the contrary, the waveform is output normally
